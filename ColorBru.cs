...
namespace WEB
{
	public static class ColorBru
	{
		...
		public enum Code
		{
			...
			RdYlBu, Spectral, RdYlGn, Accent, Dark2, Paired, Pastel1, Pastel2, Set1, Set2, Set
		...
		public static string[] GetHtmlCodes(Code code, byte numberOfColors)
		{
			return Palettes.Single(c => c.Code == code).HtmlCodes.Single(p => p.Length == numberOfColors);
		}

		public static List<Color> GetColors(Code code, byte numberOfColors)
		{
